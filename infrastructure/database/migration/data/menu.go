...
func GetMenus(db *gorm.DB) []schema.Menu {
	...
	return []schema.Menu{
		// Beef
		{
			...
			IsAvailable: true,
			CookingTime: schema.Duration{Duration: 2 * time.Hour},
		...
		},
		{
			...
			IsAvailable: true,
			CookingTime: schema.Duration{Duration: 4*time.Hour + 15*time.Minute},
		...
		},
		{
			...
			IsAvailable: true,
			CookingTime: schema.Duration{Duration: 2*time.Hour + 15*time.Minute},
		...
		},
		{
			...
			IsAvailable: true,
			CookingTime: schema.Duration{Duration: 3*time.Hour + 30*time.Minute},
		...
		},
		{
			...
			IsAvailable: true,
			CookingTime: schema.Duration{Duration: 1*time.Hour + 45*time.Minute},
		...
		},
		{
			...
			IsAvailable: true,
			CookingTime: schema.Duration{Duration: 2*time.Hour + 30*time.Minute},
		...
		},
		{
			...
			IsAvailable: true,
			CookingTime: schema.Duration{Duration: 1 * time.Hour},
		...
		// Chicken
		{
			...
			IsAvailable: true,
			CookingTime: schema.Duration{Duration: 1*time.Hour + 15*time.Minute},
		...
		},
		{
			...
			IsAvailable: true,
			CookingTime: schema.Duration{Duration: 1*time.Hour + 30*time.Minute},
		...
		},
		{
			...
			IsAvailable: true,
			CookingTime: schema.Duration{Duration: 40 * time.Minute},
		...
		},
		{
			...
			Price:       decimal.NewFromInt(39000),
			IsAvailable: true,
			CookingTime: schema.Duration{Duration: 50 * time.Minute},
		...
		},
		{
			...
			IsAvailable: true,
			CookingTime: schema.Duration{Duration: 1*time.Hour + 10*time.Minute},
		...
		// Miscellaneous
		{
			...
			IsAvailable: true,
			CookingTime: schema.Duration{Duration: 3 * time.Hour},
		...
		},
		{
			...
			Price:       decimal.NewFromInt(48000),
			IsAvailable: true,
			CookingTime: schema.Duration{Duration: 30 * time.Minute},
		...
		},
		{
			...
			IsAvailable: true,
			CookingTime: schema.Duration{Duration: 25 * time.Minute},
		...
		},
		{
			...
			IsAvailable: true,
			CookingTime: schema.Duration{Duration: 1*time.Hour + 20*time.Minute},
